#!/bin/bash
# Build ESP32 PPPoE Router firmware and collect binaries into firmware/
set -e
...
echo "=== ESP32 PPPoE Router firmware build ==="
...
cp "$BUILD_DIR/esp32_pppoe_router.bin"                "$OUT_DIR/esp32_pppoe_router.bin"
...
echo "    0x20000 $OUT_DIR/esp32_pppoe_router.bin"
