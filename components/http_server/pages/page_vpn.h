...
textarea { width: 100%; background: rgba(22, 27, 34, 0.6); border: 1px solid rgba(126, 184, 212, 0.2); border-radius: 8px; color: #e0e0e0; padding: 0.75rem; font-size: 0.85rem; font-family: monospace; resize: vertical; }\
textarea:focus { outline: none; border-color: #7eb8d4; box-shadow: 0 0 0 3px rgba(126, 184, 212, 0.1); }\
...
document.body.innerHTML ='<div id=\"container\"><h1>WireGuard VPN</h1><p style=\"text-align:center; margin: 2rem 0; color: #7eb8d4;\">Settings saved! Rebooting...</p></div>';\
...
<h2>Import Config</h2>\
<p style='color:#888; font-size:0.85rem; margin-bottom:0.5rem;'>Paste a WireGuard .conf. The fields above are filled and the device reboots.</p>\
...
m.style.color='#7eb8d4';m.textContent='Importing...';\
