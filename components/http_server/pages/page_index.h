...
#define INDEX_TITLE "ESP32 PPPoE Router"
#else
...
box-shadow: 0 4px 15px rgba(45, 106, 143, 0.4);\
text-align: center;\
}\
\
.nav-button:hover {\
transform: translateY(-2px);\
box-shadow: 0 6px 20px rgba(45, 106, 143, 0.6);\
}\
\
.nav-button:active {\
...
IDF_VER\
" | <a href='https://github.com/martin-ger/esp32_PPPoE_router' target='_blank' rel='noopener' style='color: #7eb8d4; text-decoration: none;'>Source</a></span>\
</div>\
</div>\
</body>\
</html>"
