...
#container { max-width: 700px; margin: 0 auto; padding: 1.5rem; background: rgba(26, 29, 33, 0.9); border-radius: 16px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.4); }\
...
.connect-button { background: linear-gradient(135deg, #2d6a8f 0%%, #1e4d6b 100%%); color: #fff; border: none; border-radius: 6px; padding: 0.4rem 0.8rem; font-size: 0.8rem; font-weight: 600; cursor: pointer; text-decoration: none; display: inline-block; }\
.connect-button:hover { transform: translateY(-1px); box-shadow: 0 4px 12px rgba(45, 106, 143, 0.4); }\
