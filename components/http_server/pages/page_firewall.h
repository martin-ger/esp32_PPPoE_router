...
h2 { font-size: 1.1rem; font-weight: 500; color: #7eb8d4; margin: 1.2rem 0 0.5rem 0; padding-bottom: 0.3rem; border-bottom: 1px solid rgba(126, 184, 212, 0.2); }\
h3 { font-size: 0.95rem; font-weight: 500; color: #9acde0; margin: 0.8rem 0 0.3rem 0; }\
#container { max-width: 900px; margin: 0 auto; padding: 1.5rem; background: rgba(26, 29, 33, 0.9); border-radius: 16px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.4); }\
.data-table { width: 100%; border-collapse: collapse; margin: 0.5rem 0; background: rgba(22, 27, 34, 0.6); border-radius: 8px; overflow: hidden; border: 1px solid rgba(126, 184, 212, 0.1); font-size: 0.8rem; }\
.data-table thead { background: rgba(126, 184, 212, 0.1); }\
.data-table th { padding: 0.4rem 0.2rem; text-align: left; font-weight: 600; color: #7eb8d4; font-size: 0.75rem; }\
...
input[type='text'], input[type='number'], select { width: 100%; background: rgba(22, 27, 34, 0.6); border: 1px solid rgba(126, 184, 212, 0.2); border-radius: 6px; color: #e0e0e0; padding: 0.4rem; font-size: 0.85rem; }\
input:focus, select:focus { outline: none; border-color: #7eb8d4; }\
.ok-button { background: linear-gradient(135deg, #2d6a8f 0%, #1e4d6b 100%); color: #fff; border: none; border-radius: 6px; padding: 0.5rem 1rem; font-size: 0.85rem; font-weight: 600; cursor: pointer; width: 100%; margin-top: 0.25rem; }\
.red-button { background: linear-gradient(135deg, #b03a2e 0%, #7b241c 100%); color: #fff; border: none; border-radius: 4px; padding: 0.2rem 0.4rem; font-size: 0.7rem; font-weight: 600; cursor: pointer; text-decoration: none; display: inline-block; }\
...
.acl-section { margin-bottom: 1rem; padding: 0.8rem; background: rgba(22, 27, 34, 0.4); border-radius: 10px; border: 1px solid rgba(126, 184, 212, 0.1); }\
...
.modal-box button { background: linear-gradient(135deg, #2d6a8f 0%, #1e4d6b 100%); color: #fff; border: none; border-radius: 6px; padding: 0.5rem 1.5rem; font-size: 0.9rem; font-weight: 600; cursor: pointer; }\
</style>\
<body>"
...
<a href='/' style='padding: 0.6rem 1.5rem; background: linear-gradient(135deg, #2d6a8f 0%, #1e4d6b 100%); color: #fff; border: none; border-radius: 8px; text-decoration: none; font-size: 0.9rem; font-weight: 600;'>🏠 Home</a>\
</div>\
</div>\
</body>\
</html>"
