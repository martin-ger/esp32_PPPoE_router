...
input[type='text'], input[type='password'] { width: 100%; background: rgba(22, 27, 34, 0.6); border: 1px solid rgba(126, 184, 212, 0.2); border-radius: 8px; color: #e0e0e0; padding: 0.75rem; font-size: 0.95rem; }\
input[type='text']:focus, input[type='password']:focus { outline: none; border-color: #7eb8d4; box-shadow: 0 0 0 3px rgba(126, 184, 212, 0.1); background: rgba(22, 27, 34, 0.8); }\
...
.nav-link { display: inline-block; padding: 0.6rem 1.5rem; background: linear-gradient(135deg, #2d6a8f 0%, #1e4d6b 100%); color: #fff; border: none; border-radius: 8px; text-decoration: none; font-size: 0.9rem; font-weight: 600; margin-right: 0.5rem; }\
...
document.body.innerHTML ='<div id=\"container\"><h1>Getting Started</h1><p style=\"text-align:center; margin: 2rem 0; color: #7eb8d4;\">Settings saved! Rebooting...</p></div>';\
