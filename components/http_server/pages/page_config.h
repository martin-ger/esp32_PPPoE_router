...
input[type='text'], input[type='password'], input[type='number'] { width: 100%; background: rgba(22, 27, 34, 0.6); border: 1px solid rgba(126, 184, 212, 0.2); border-radius: 8px; color: #e0e0e0; padding: 0.75rem; font-size: 0.95rem; }\
input[type='text']:focus, input[type='password']:focus, input[type='number']:focus, select:focus { outline: none; border-color: #7eb8d4; box-shadow: 0 0 0 3px rgba(126, 184, 212, 0.1); background: rgba(22, 27, 34, 0.8); }\
...
input[type='checkbox'], input[type='radio'] { -webkit-appearance: none; -moz-appearance: none; appearance: none; width: 18px; height: 18px; border: 2px solid rgba(126, 184, 212, 0.3); border-radius: 4px; background: rgba(22, 27, 34, 0.6); cursor: pointer; vertical-align: middle; position: relative; flex-shrink: 0; }\
input[type='radio'] { border-radius: 50%; }\
input[type='checkbox']:checked, input[type='radio']:checked { background: #7eb8d4; border-color: #7eb8d4; }\
input[type='checkbox']:checked::after { content: ''; position: absolute; left: 4px; top: 1px; width: 6px; height: 10px; border: solid #1a1d21; border-width: 0 2px 2px 0; transform: rotate(45deg); }\
input[type='radio']:checked::after { content: ''; position: absolute; left: 3px; top: 3px; width: 8px; height: 8px; border-radius: 50%; background: #1a1d21; }\
input[type='checkbox']:focus, input[type='radio']:focus { outline: none; border-color: #7eb8d4; box-shadow: 0 0 0 3px rgba(126, 184, 212, 0.1); }\
...
.ok-button { background: linear-gradient(135deg, #2d6a8f 0%, #1e4d6b 100%); color: #fff; box-shadow: 0 4px 15px rgba(45, 106, 143, 0.4); }\
.red-button { background: linear-gradient(135deg, #b03a2e 0%, #7b241c 100%); color: #fff; box-shadow: 0 4px 15px rgba(176, 58, 46, 0.4); }\
...
document.body.innerHTML ='<div id=\"container\"><h1>Configuration</h1><p style=\"text-align:center; margin: 2rem 0; color: #7eb8d4;\">Settings saved! Rebooting...</p></div>';\
...
<tr><td>Hostname</td><td><input type='text' name='ap_hostname' value='%s' placeholder='esp32-pppoe-router' maxlength='32' pattern='[A-Za-z0-9-]*'/></td></tr>\
...
<table>\
<tr><td>Upload</td><td>\
<label style='display:inline-block;padding:0.6rem 1rem;background:rgba(22,27,34,0.6);border:1px solid rgba(126,184,212,0.2);border-radius:8px;color:#e0e0e0;font-size:0.9rem;cursor:pointer;transition:all 0.3s;margin-bottom:0.5rem;'>\
...
<div id='otaBar' style='display:none;height:6px;background:rgba(126,184,212,0.2);border-radius:3px;overflow:hidden;'>\
<div id='otaBarFill' style='height:100%;width:0;background:#7eb8d4;transition:width 0.3s;'></div>\
</div>\
</div>\
...
<table>\
<tr><td>Export</td><td>\
<input type='password' id='expPass' placeholder='Passphrase (leave empty for plain)' style='width:100%;margin-bottom:0.4rem;background:rgba(22,27,34,0.6);border:1px solid rgba(126,184,212,0.2);border-radius:8px;color:#e0e0e0;padding:0.6rem;font-size:0.9rem;box-sizing:border-box;'/><br/>\
...
<tr><td>Import</td><td>\
<input type='password' id='impPass' placeholder='Passphrase (if encrypted)' style='width:100%;margin-bottom:0.4rem;background:rgba(22,27,34,0.6);border:1px solid rgba(126,184,212,0.2);border-radius:8px;color:#e0e0e0;padding:0.6rem;font-size:0.9rem;box-sizing:border-box;'/><br/>\
<label style='display:inline-block;padding:0.6rem 1rem;background:rgba(22,27,34,0.6);border:1px solid rgba(126,184,212,0.2);border-radius:8px;color:#e0e0e0;font-size:0.9rem;cursor:pointer;transition:all 0.3s;margin-bottom:0.5rem;'>\
...
<p style='font-size:1.5rem;font-weight:bold;color:#7eb8d4;' id='countdown'></p>\
...
<a href='/' style='padding: 0.75rem 2rem; background: linear-gradient(135deg, #2d6a8f 0%, #1e4d6b 100%); color: #fff; border: none; border-radius: 8px; text-decoration: none; font-size: 0.95rem; font-weight: 600;'>🏠 Home</a>\
</div>\
</div>\
</body>\
</html>"
