...
#container { max-width: 800px; margin: 0 auto; padding: 1.5rem; background: rgba(26, 29, 33, 0.9); border-radius: 16px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.4); backdrop-filter: blur(10px); }\
.nav-link { color: #7eb8d4; text-decoration: none; font-size: 0.9rem; display: inline-block; margin-bottom: 1rem; transition: all 0.2s; }\
.nav-link:hover { color: #9acde0; transform: translateX(-3px); }\
.data-table { width: 100%; border-collapse: collapse; margin: 1rem 0; background: rgba(22, 27, 34, 0.6); border-radius: 12px; overflow: hidden; border: 1px solid rgba(126, 184, 212, 0.1); }\
.data-table thead { background: rgba(126, 184, 212, 0.1); }\
.data-table th { padding: 0.75rem 0.5rem; text-align: left; font-weight: 600; color: #7eb8d4; font-size: 0.9rem; }\
...
.data-table tbody tr:hover { background: rgba(126, 184, 212, 0.05); }\
...
input[type='text'], input[type='number'], select { width: 100%; background: rgba(22, 27, 34, 0.6); border: 1px solid rgba(126, 184, 212, 0.2); border-radius: 8px; color: #e0e0e0; padding: 0.75rem; font-size: 0.95rem; transition: all 0.3s; }\
input:focus, select:focus { outline: none; border-color: #7eb8d4; box-shadow: 0 0 0 3px rgba(126, 184, 212, 0.1); background: rgba(22, 27, 34, 0.8); }\
input::placeholder { color: #666; }\
select { cursor: pointer; }\
.ok-button { background: linear-gradient(135deg, #2d6a8f 0%, #1e4d6b 100%); color: #fff; border: none; border-radius: 8px; padding: 0.75rem 1.5rem; font-size: 0.95rem; font-weight: 600; cursor: pointer; transition: all 0.3s; box-shadow: 0 4px 15px rgba(45, 106, 143, 0.4); width: 100%; margin-top: 0.5rem; }\
.ok-button:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(45, 106, 143, 0.6); }\
.red-button { background: linear-gradient(135deg, #b03a2e 0%, #7b241c 100%); color: #fff; border: none; border-radius: 6px; padding: 0.4rem 0.8rem; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.3s; box-shadow: 0 2px 8px rgba(176, 58, 46, 0.4); text-decoration: none; display: inline-block; }\
.red-button:hover { transform: translateY(-1px); box-shadow: 0 4px 12px rgba(176, 58, 46, 0.6); }\
...
.modal-box { background: rgba(26, 29, 33, 0.98); border: 2px solid #b03a2e; border-radius: 12px; padding: 1.5rem; max-width: 400px; text-align: center; box-shadow: 0 8px 32px rgba(176, 58, 46, 0.3); }\
.modal-box h3 { color: #b03a2e; margin-bottom: 1rem; }\
.modal-box p { color: #e0e0e0; margin-bottom: 1.5rem; }\
.modal-box button { background: linear-gradient(135deg, #2d6a8f 0%, #1e4d6b 100%); color: #fff; border: none; border-radius: 8px; padding: 0.75rem 2rem; font-size: 1rem; cursor: pointer; }\
...
.select-button { background: linear-gradient(135deg, #2d6a8f 0%, #1e4d6b 100%); color: #fff; border: none; border-radius: 6px; padding: 0.4rem 0.8rem; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.3s; box-shadow: 0 2px 8px rgba(45, 106, 143, 0.4); text-decoration: none; display: inline-block; }\
.select-button:hover { transform: translateY(-1px); box-shadow: 0 4px 12px rgba(45, 106, 143, 0.6); }\
...
<a href='/' style='padding: 0.75rem 2rem; background: linear-gradient(135deg, #2d6a8f 0%, #1e4d6b 100%); color: #fff; border: none; border-radius: 8px; text-decoration: none; font-size: 0.95rem; font-weight: 600; cursor: pointer; transition: all 0.3s; box-shadow: 0 4px 15px rgba(45, 106, 143, 0.4); display: inline-block;'>&#127968; Home</a>\
</div>\
</div>\
</body>\
</html>"
